...
{
    public class AppAsyncCrudService<TEntityDto, TEntity, TPrimaryKey> : AppServiceBase<TEntityDto, TEntity, TPrimaryKey>, IAppAsyncCrudService<TEntityDto, TEntity, TPrimaryKey>
